...
<div class="container-fluid">
    <form action="/update/{{$stock-> IDStock}}" method="POST">
        @csrf
        <div class="modal-header">
            <div class="col-xs-6">
                <h4>Change New Stock</h4>
            </div>
        </div>
        <div class="modal-body">
            <div class="form-group">
                <label>Address</label>
                <input type="text" value="{{$stock->Address}}" name="address" class="form-control" required>
            </div>
            <div class="form-group">
                <label>Free Count</label>
                <input type="text" value="{{$stock->FreeCounts}}" name="count" class="form-control" required>
            </div>
        </div>
